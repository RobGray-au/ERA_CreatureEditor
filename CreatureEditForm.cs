...
namespace CreatureXmlEditor
{
    public partial class CreatureEditForm : Form
    {
        ...
        #region Skills
        private void grpSkills_Enter(object sender, EventArgs e)
        {
        ...
        private void BtnAddSkill_Click(object sender, EventArgs e)
        {
            ...
            if (btnAddSkill.Text == "Update" && lstSkills.SelectedIndex >= 0)
            {
                // Update existing attack
                var skill = creature.ManeuverSkills.Skills[lstSkills.SelectedIndex];
                skill.Name = txtSkillName.Text;
                skill.TableName = txtSkillTableName.Text;
                skill.Bonus = (int)numSkillBonus.Value;
                skill.Ranks = (int)numSkillRanks.Value;
            }
            else
            {
